...
public:
  ...
  */
   ...
   * \param tti transmission time interval
   */
  void SetStti (double stti);                      //sachin
   ...
   * \returns transmission time interval
   */
  double GetStti (void) const;                    //sachin
...
/**
   * \param slot duration
   */
  void SetSlot (double slot);
  /**
   * \returns slot duration
   */
  double GetSlot (void) const;

/**
   * \param sub frame duration
   */
  void SetSfDuration (double sfDuration);
  /**
   * \returns sub frame duration
   */
  double GetSfDuration (void) const;
