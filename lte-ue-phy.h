...
public:
  ...
  */
  ...
  void SetMacChDelay (uint8_t);


  /**
   * \returns the TTI delay between MAC and channel for UE
   */
  uint8_t GetMacChDelayUe (void) const;

  void SetMacChDelayUe (uint8_t);
...
private:
  ...
  uint16_t m_nUe;                  //sachin
  uint16_t m_kUe;                  //sachin
